...
- **Don't** silently select a quilt or invent authenticated actions; joining, following, suggesting a patch, and governance remain website links in this browsing pass, and Dashboard and notifications wait for sign-in rather than standing in the shell as stubs.
